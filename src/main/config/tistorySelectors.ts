export const TISTORY_SELECTORS = {
  ...
  PUBLISH: {
    ...
    // [NEW] 예약 발행 관련 선택자
    RADIO_CURRENT: "#public-radio-current",
    RADIO_RESERVATION: "#public-radio-reservation",
    LABEL_RESERVATION: "label:has-text('예약')",
    INPUT_DATE: ".inp_date",
    INPUT_TIME: ".inp_time",
  ...
  MANAGE_CATEGORY: {
    URL: (blogName: string) =>
      `https://${blogName}.tistory.com/manage/category`,
